...
Alur : Python => Bahasa pemrograman interpreted
((versi interpreted))
source code->intepreter(langsung diterjemahkan)->terminal //di eksekusi sebaris-sebaris
Di eksekusi dari urutan atas ke bawah, klo baris kosong bakal dilewatin
((versi compile)) 
Bisa di compile kek .exe dengan bytecode 
->caranya python -m py_compile nama file abis itu cd nama folder then jalanin filenya
Pakai yang compile lebih cepat dari intepreted

Komen : # versi sebaris ajah
"""

print('hello everybadiw')

a="cantik"
b="adel"
print(b)
print('hello everybadih')